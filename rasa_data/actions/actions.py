...
class ActionSearchHydrometricStationByName(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        # 连接数据库
        conn = pymysql.connect(host='localhost', port=3306, user='root', password='marsh502418.', db='hydrology', charset='utf8')
...
class ActionDrawWaterLevelAndFlowRelationshipLine(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        conn = pymysql.connect(host='localhost', port=3306, user='root', password='marsh5024418.', db='hydrology', charset='utf8')
        cur = conn.cursor(pymysql.cursors.DictCursor) # 生成游标对象
